...
def process_log_data(spark, input_data, output_data):
    ...
    artists_songs_logs = songs_logs.alias('a').join(artists_df.alias('t'), (songs_logs.artist == artists_df.name) | (songs_logs.location == artists_df.location), 'left')
    songplays = artists_songs_logs.join(time_table, artists_songs_logs.ts_timestamp == time_table.start_time, 'left')
...
if __name__ == "__main__":
    root_bucket = r'/Users/pedresnyman/PycharmProjects/aws_datalake/testing/results/'
    input_data = r'/Users/pedresnyman/PycharmProjects/aws_datalake/testing/'
    step_app_name = 'Datalake-Sparkify'
    spark = create_spark_session(step_app_name)
    input_data = input_data
    output_data = root_bucket
    main(root_bucket, input_data, step_app_name)
